...
class ViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user_invalid_email = {'user':{'username':'samuel', 'email':'samuelgmail.com', 'password':'password'}}
    ...
    def test_register_with_an_invalid_email(self):
        ...
        response = self.client.post('/api/users/',self.user_invalid_email,format="json")
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
